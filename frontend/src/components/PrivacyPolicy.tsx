      ...
      <div>
        ...
        <div className="text-left">
          <p className="leading-relaxed">
            melBee,
            Inc.（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下、「本ポリシー」といいます。）を定めます。
          </p>
          <h3 className="mt-2 font-bold">第1条（個人情報）</h3>
          <p className="leading-relaxed">
            「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名、生年月日、住所、電話番号、連絡先その他の記述等により特定の個人を識別できる情報及び容貌、指紋、声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
          </p>
          <h3 className="mt-2 font-bold">第2条（個人情報の収集方法）</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="mt-2 font-bold">第4条（利用目的の変更）</h3>
          <p className="leading-relaxed">
            当社は、利用目的が変更前と関連性を有すると合理的に認められる場合に限り、個人情報の利用目的を変更するものとします。
            <br />
            利用目的の変更を行った場合には、変更後の目的について、当社所定の方法により、ユーザーに通知し、または本ウェブサイト上に公表するものとします。
          </p>
          <h3 className="mt-2 font-bold">第5条（個人情報の第三者提供）</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="mt-2 font-bold">第6条（個人情報の開示）</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="mt-2 font-bold">第7条（個人情報の訂正および削除）</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="mt-2 font-bold">第8条（個人情報の利用停止等）</h3>
          <p className="leading-relaxed">
          ...
          <h3 className="mt-2 font-bold">第10条（お問い合わせ窓口）</h3>
          <p className="leading-relaxed">
