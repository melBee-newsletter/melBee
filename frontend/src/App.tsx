  ...
  return (
    <BrowserRouter>
        <Routes>
          ...
          <Route path="/user/send" element={<Central displayComponent={<Sending analytics={analytics} reachLimit={reachLimit} setCountSent={setCountSent} /> } reachLimit={reachLimit} />} />
