      ...
      <Editor
        ...
        init={{
          ...
          font_family_family_formats:
            "Arial=arial,helvetica,sans-serif; Century Gothic = century gothic; Garamond = garamond; Georgia=georgia,palatino; Helvetica=helvetica; Impact=impact,chicago;Lucida = lucida; Tahoma=tahoma,arial,helvetica,sans-serif; Times New Roman=times new roman,times;  Verdana=verdana,geneva",
